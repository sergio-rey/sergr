        ...
        <div className="container">
            <div className="project">
                ...
                <div className="img">
                    ...
                    <Image layout="fixed" className="img_project" src={project1} width={580} height={360}></Image>
                </div>
            </div>
            <div className="project">
                <div className="img">
                    <div className="img_effect"></div>
                    <Image layout="fixed" className="img_project" src={project2} width={580} height={360}></Image>
                </div>
                <div className="text_f"></div>
